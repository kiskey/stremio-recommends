...
def generate_sorted_recommendations(media_type: str, skip: int = 0):
    ...
    candidate_scores, full_history_ids = {}, set(pd.read_sql_query("SELECT imdb_id FROM history", conn)['imdb_id'])
    conn.close()
    ...
    paginated_df = full_sorted_df.iloc[skip : skip + PAGE_SIZE]
...
# --- Helper functions and Application Factory ---
